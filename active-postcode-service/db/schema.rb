...
ActiveRecord::Schema.define(version: 20150917085058) do
  ...
  add_index "coordinates", ["polygon_id"], name: "index_coordinates_on_polygon_id", using: :btree

  create_table "polygons", force: :cascade do |t|
    t.integer "post_code_id"
  end

  add_index "polygons", ["post_code_id"], name: "index_polygons_on_post_code_id", using: :btree
  ...
  add_index "suburbs", ["post_code_id"], name: "index_suburbs_on_post_code_id", using: :btree
  add_index "suburbs", ["state_id"], name: "index_suburbs_on_state_id", using: :btree
